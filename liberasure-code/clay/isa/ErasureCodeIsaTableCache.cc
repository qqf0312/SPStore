...
// {
//   return std::cout << "ErasureCodeIsaTableCache: ";
// }
                                                    ...
                                                    int m)
{
  ...
  std::cout << "[ get table    ] = " << signature << std::endl;
  ...
  if (decode_tbls_map->count(signature)) {
    std::cout << "[ cached table ] = " << signature << std::endl;
    ...
    std::cout << "[ cache size   ] = " << decode_tbls_lru->size() << std::endl;
                                                  ...
                                                  int m)
{
  ...
  std::cout << "[ put table    ] = " << signature << std::endl;
  ...
  if ((int) decode_tbls_lru->size() >= ErasureCodeIsaTableCache::decoding_tables_lru_length) {
    std::cout << "[ shrink lru   ] = " << signature << std::endl;
    // reuse old buffer
    ...
    std::cout << "[ store table  ] = " << signature << std::endl;
