...
my $ldata   = '/home/ubuntu/ex_sharding/deps/data';
my $execdir = '/home/ubuntu/ex_sharding/deps/bin';
my $bindir  = '/home/ubuntu/ex_sharding/deps/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/home/ubuntu/ex_sharding/deps/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/home/ubuntu/ex_sharding/deps/include', "include/mysql", "include");
