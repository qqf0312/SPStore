...
public:
    ...
    virtual std::shared_ptr<dev::executive::StateFactoryInterface> getstateFactory() = 0;
    // virtual std::shared_ptr<dev::executive::StateFace> getMPTState(std::shared_ptr<dev::blockverifier::ExecutiveContext> context) = 0;
