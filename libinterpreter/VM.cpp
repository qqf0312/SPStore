...
void VM::interpretCases()
{
    ...
    DO_CASES
    {
            ...
            CASE(RETURNDATASIZE)
        {
            if (m_rev < EVMC_BYZANTIUM)
            {
                std::cout << "RETURNDATASIZE" << std::endl;
                throwBadInstruction();
            }
            ...
            CASE(RETURNDATACOPY)
        {
            ...
            if (m_rev < EVMC_BYZANTIUM)
            {
                std::cout << "RETURNDATACOPY" << std::endl;
            ...
            CASE(SSTORE)
        {
            ...
            // std::cout<<"interpreter::set_storage"<<std::endl;
