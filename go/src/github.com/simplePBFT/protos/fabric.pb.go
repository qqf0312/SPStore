...
type Message struct {
	...
	ReplicaId uint64                     `protobuf:"varint,5,opt,name=replicaId" json:"replicaId,omitempty"`
}
...
type GreeterClient interface {
	// 服务端返馈信息方法
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*Block, error)
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*Block, error) {
	out := new(Block)
...
type GreeterServer interface {
	// 服务端返馈信息方法
	SayHello(context.Context, *HelloRequest) (*Block, error)
}
