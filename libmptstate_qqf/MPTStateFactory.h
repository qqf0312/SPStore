...
public:
    ...
    //  qqf 因为override有错误注释掉的
    // virtual std::shared_ptr<dev::mptstate::MPTState> getMPTState()  override;
    virtual std::shared_ptr<dev::mptstate::MPTState> getMPTState();
private:
    dev::OverlayDB m_db;
    u256 m_accountStartNonce;
    boost::filesystem::path m_basePath;
    h256 m_genesisHash;
    std::shared_ptr<dev::mptstate::MPTState> m_state;
    bool flag =false;
};
