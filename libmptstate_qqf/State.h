 ...
 */
        ...
        public:
            ...
            // static OverlayDB openDB(boost::filesystem::path const& _path, h256 const& _genesisHash,
            //     WithExisting _we = WithExisting::Trust,State* s);
        ...
        private:
            ...
            //modified 2020/8
            Address m_data_contract = FixedHash<20>("0x522e184cD6B281C023D8801dF8325145cCA18Cf5");
            std::unordered_set<Address> m_compute_contract;
            Address m_compute_contract1 =  FixedHash<20>("0x2C040c334823d9740826c5abb042F63EC317fd42");
            Address m_compute_contract2 =  FixedHash<20>("0x934c007a192Bbf5E9d4a4e7CD3F5Fc136E7664B1");
            Address m_compute_contract3 =  FixedHash<20>("0xC784AFc268CB6E3bef4D9285C53AD7db9760db43");
            Address m_compute_contract4 =  FixedHash<20>("0xC24976990C0eB913291996a45CAe56B4704a625E");
            mutable std::unordered_map<Address,SecureTrieDB<Address, OverlayDB>> m_contract_state;
