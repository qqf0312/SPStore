...
public:
    ...
    virtual dev::h512s getNodeListByShardID(GROUP_ID groupID) = 0;
    virtual void setShardID2NodeList(std::map<GROUP_ID, dev::h512s> _groupID2NodeList) = 0;
    virtual void setNodeListByShardID(GROUP_ID _groupID, const dev::h512s& _nodeList) = 0;
