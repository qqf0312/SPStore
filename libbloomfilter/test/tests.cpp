...
//     void serialize(Archive & ar, bitvector& b, const unsigned int version)
//     {
//       std::cout << "tests.cpp se" << std::endl;
//         // hasher& h, ar & h; 
//         ar & b;
//     }
// } // namespace serialization
...
// int main(){
//   basic_bloom_filter bf(0.8, 2000);
...
//   std::stringstream ofs("data");
//   boost::archive::binary_oarchive oa(ofs);
//   // oa << b;
//   oa << h << b;
//   std::cout << "serilization ok" << std::endl;
//   // std::stringstream ifs("data");
//   boost::archive::binary_iarchive   ia(ofs);
//   // basic_bloom_filter obf;
//   hasher h1;
//   bitvector b1;
//   ia>>  h1 >> b1;
...
//   basic_bloom_filter obfc(h1, b1);
//   std::cout << obfc.lookup("foo") << std::endl;
